...
void Text::init(std::string textString)
{
...
void Text::init(const char* textString)
{
...
void Text::init(unsigned int assignedTextNumber, const char* textString)
{
...
{
	agk::SetTextPosition(textNumber, x, y);
}
