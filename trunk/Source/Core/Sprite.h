...
public:
	...
	void parentInit(Text Filename, bool blackIsAlpha = false, unsigned int assignedSpriteNumber = 0, unsigned int assignedImageNumber = 0); 
	void parentInit(const char filename[], bool blackIsAlpha = false, unsigned int assignedSpriteNumber = 0, unsigned int assignedImageNumber = 0); 
	...
	void setX(float x);
	void setY(float y);
	void subInit(unsigned int parentImage, Text SubImageFilename, unsigned int assignedSpriteNumber = 0, unsigned int assignedImageNumber = 0);
	void subInit(unsigned int parentImage, const char subImageFilename[], unsigned int assignedSpriteNumber = 0, unsigned int assignedImageNumber = 0);
