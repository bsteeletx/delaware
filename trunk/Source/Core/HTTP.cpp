...
Text HTTP::getResponse()
{
	...
	ReturnText.init(agk::GetHTTPResponse(httpID));
...
Text HTTP::sendRequest(Text Page)
{
	...
	RetText.init(agk::SendHTTPRequest(httpID, Page.getString()));
...
Text HTTP::sendRequest(Text Page, Text PostData)
{
	...
	RetText.init(agk::SendHTTPRequest(httpID, Page.getString(), PostData.getString()));
