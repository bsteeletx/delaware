...
void PhysicsSprite::init(unsigned int parentImage, Text SubImageFilename, unsigned int assignedSpriteNumber, unsigned int assignedImageNumber, short mode)
{
	Sprite::subInit(parentImage, SubImageFilename, assignedSpriteNumber, assignedImageNumber);
	setOn(mode);
}

void PhysicsSprite::init(File FileToInit)
{
	//STUB
}
